...
using DarkSoulsCore.Services;
using Microsoft.AspNetCore.Mvc;
using System.Collections.Generic;
using System.Threading.Tasks;

namespace DarkSoulsVue.Controllers
{
    ...
    public class WeaponsController : Controller
    {
        ...
        [ProducesResponseType(typeof(IEnumerable<StartingClass>), 200)]
        public async Task<IActionResult> StartingClasses()
        {
            IEnumerable<StartingClass> startingClasses = await characterService.GetStartingClassesAsync();
